...
DATA_PATH = BASE_DIR / "manbyo_doctor_sft_SAB_rank1.jsonl"
BASE_MODEL = "EQUES/MedLLama3-JP-v2"
OUTPUT_DIR = BASE_DIR / "eques_doctor_expression_lora"  # EQUES用 LoRA 保存先
...
def build_formatting_func(tokenizer):
    ...
    def formatting_func(example):
        # build_manbyo_doctor_sft.py の出力は example["messages"]
